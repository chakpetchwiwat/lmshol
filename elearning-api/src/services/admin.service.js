...
const { getUsers, getUserDetails, createUser, updateUser, deleteUser, exportUserProfiles, exportUserTrainings, exportSingleUser, exportSingleUserForm, downloadTemplate, importProfiles, importTrainings, bulkAssignMentor, bulkTransferMentor } = require('./admin/admin.users');
...
const { getEligibleSupervisors, getUserCohortSupervisors, saveUserCohortSupervisors, getSupervisorTracking } = require('./admin/admin.supervisors');
...
const { getCompetencies, getCompetencyTree, createCompetencyGroup, updateCompetencyGroup, deleteCompetencyGroup, createCompetencyCategory, updateCompetencyCategory, deleteCompetencyCategory, createCompetency, updateCompetency, deleteCompetency, importGbtCompetencies, getCompetencyTypes, createCompetencyType, updateCompetencyType, deleteCompetencyType } = require('./admin/admin.competencies');
