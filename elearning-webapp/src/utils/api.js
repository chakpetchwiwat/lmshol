...
export const adminAPI = {
  ...
  getEligibleSupervisors: () => api.get('/admin/users/supervisors'),
  getUserCohortSupervisors: (userId) => api.get(`/admin/users/${userId}/cohort-supervisors`),
  saveUserCohortSupervisors: (userId, assignments) => api.post(`/admin/users/${userId}/cohort-supervisors`, { assignments }),
