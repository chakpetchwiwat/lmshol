...
export const canAccessAdminPanel = (user) => {
  ...
  return ADMIN_PANEL_PERMISSIONS.includes(permission) || user.isCourseStaff === true || user.isSupervisor === true;
};
...
export const getRoleLabel = (user) => {
  ...
  if (permission === USER_PERMISSIONS.MANAGER) return 'Manager';
