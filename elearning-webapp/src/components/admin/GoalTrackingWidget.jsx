...
import { CheckCircle2, Clock3, Printer, Target, Users, XCircle } from 'lucide-react';
      ...
      {loading ? (
        ...
        <div className="mt-6 grid grid-cols-1 gap-5">
          {goals.map((goal) => (
            <article
              key={goal.id}
              className="overflow-hidden rounded-[1.75rem] border border-slate-200 bg-gradient-to-br from-white via-slate-50/70 to-primary/5"
            >
