...
const FilterSidebar = ({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-end justify-center bg-slate-900/45 p-0 backdrop-blur-md animate-fade-in sm:p-4 md:items-center md:p-6">
      <button
        type="button"
      ...
      <div
        ...
        tabIndex={-1}
        className="relative flex h-[88dvh] w-full max-w-xl flex-col overflow-hidden rounded-t-[2rem] rounded-b-none bg-white shadow-[0_30px_90px_-30px_rgba(15,23,42,0.55)] animate-slide-up md:h-auto md:max-h-[88dvh] md:rounded-[2.25rem]"
      >
        <div className="flex shrink-0 justify-center pb-2 pt-3 md:hidden">
          <div className="h-1.5 w-14 rounded-full bg-slate-200" />
        </div>

        <div className="border-b border-slate-100 bg-gradient-to-b from-slate-50/90 to-white px-6 pb-5 pt-4 md:px-8 md:pb-6 md:pt-7">
